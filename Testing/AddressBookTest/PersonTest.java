...
public class PersonTest {
    ...
    * empty string or null is used as the firstName parameter
    ...
    * */
    ...
    /*
     * Test that the IllegalArgumentException is thrown when an
     * empty string or null is used as the lastName parameter
     * of the Person constructor.
     * */
    @Test
     ...
     * the zip parameter of the Person object is neither of length 5,
     * length 0, or not a number.
     */
    @Test
    ...
    // Test invalid inputs for phone parameter.
    @Test
    public void PersonPhoneInvalidInputs() {
        Assert.assertThrows(NumberFormatException.class, () -> {
            Person personException = new Person(
                "Joe",
                "Gonzalez",
